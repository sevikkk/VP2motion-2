...
//
// $Id: msg.c,v 1.1.4.1 2007/08/20 06:08:22 tshui Exp $
//
//////////////////////////////////////////////////////////////////////////////
...
extern void* xil_malloc    (size_t size);
extern void  xil_free      (void *ptr);
...
#else
#define MSGQ_MALLOC(siz)        xil_malloc(siz)
#define MSGQ_FREE(ptr)          xil_free(ptr)
#endif  /* USE_MALLOC */
#else
