...
//
// $Id: pthread.c,v 1.1.4.1 2007/08/20 06:08:22 tshui Exp $
//
//////////////////////////////////////////////////////////////////////////////
...
extern void setup_initial_context (process_struct *pcb, pid_t parent, unsigned int startaddr, unsigned int stackaddr);
                        ...
                        void *(*start_func)(void*), void *param)
{
    ...
    setup_initial_context (&ptable[pid], current_pid, (unsigned int)pthread_wrapper, stackaddr);
